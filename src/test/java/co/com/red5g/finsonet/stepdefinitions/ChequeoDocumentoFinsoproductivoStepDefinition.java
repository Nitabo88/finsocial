...
import static co.com.red5g.finsonet.userinterfaces.ChequeoDocumentosPage.LST_CHEQUEO_NOMBRE_FINSOPRODUCTIVO;
import static co.com.red5g.utils.conexionbd.QueriesFinsonet.SQL_CONSULTAR_CREDITO_FINSOPRODUCTIVO;
...
public class ChequeoDocumentoFinsoproductivoStepDefinition {

  @Dado("^que (.*) esta en el paso de chequeo de documentos finsoproductivo$")
  ...
  public void adjuntarInformacion() {
    theActorInTheSpotlight().attemptsTo(
        Diligencia.laInformacionDeChequeoDeDocumentos(con().finsoamigo(), theActorInTheSpotlight().asksFor(
            LaInformacion.deBaseDeDatos(CredencialesBDBuilder.con().bdCreditos(), SQL_CONSULTAR_CREDITO_FINSOPRODUCTIVO.getSql(), "id")), LST_CHEQUEO_NOMBRE_FINSOPRODUCTIVO)
    );
  }
}
