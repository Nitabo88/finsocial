...
Característica:  Aprobación Crédito
  ...
  @LibranzaDigital
  @AprobacionLibranzaDigital
  Escenario: Aprobación de Créditos Libranza Digital - Aprobar el crédito desde aprobación de créditos
    Dado que un asesor esta en el paso de aprobación de créditos de libranza digital
    Cuando el asesor aprueba el crédito de libranza
    Entonces el asesor deberá ver el crédito en el paso de incorporación