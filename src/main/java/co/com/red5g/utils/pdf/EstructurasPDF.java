...
public class EstructurasPDF {
  ...
  public static Integer solicitudAfiliacionCoperativa(String filaCampo) {
    ...
    map.put("FATCA-5", 14);
    map.put("FATCA-6", 15);
    map.put("Declaracion Origen Fondos", 16);
    map.put("Declaracion Tributaria Exterior", 17);
    ...
    map.put("Contrato de fianza - Dias", 31);
    map.put("Contrato de fianza - Mes", 31);
    map.put("Contrato de fianza - Año", 31);
