...
public class Simulacion implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.attemptsTo(
        ...
        WaitFor.seconds(TIEMPO_3));
    valoresSimulacion.add(0, valorMinimo);
    valoresSimulacion.add(1, plazo);
    valoresSimulacion.add(2, LBL_TASA_LIBRANZA.resolveFor(actor).getValue());
    valoresSimulacion.add(3, LBL_CUOTA_CREDITO.resolveFor(actor).getText());
    valoresSimulacion.add(4, LBL_CUOTA_SEGURO_VIDA.resolveFor(actor).getText());
    valoresSimulacion.add(5, LBL_VALOR_CREDITO.resolveFor(actor).getText());
    valoresSimulacion.add(6, LBL_BANCA_SEGURO.resolveFor(actor).getText());
