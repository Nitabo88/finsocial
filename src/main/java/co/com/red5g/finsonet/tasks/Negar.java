...
public class Negar implements Task {
    private AprobacionCredito aprobacionCredito;

    public Negar(AprobacionCredito aprobacionCredito) {
        this.aprobacionCredito = aprobacionCredito;
    }

    public static Performable laAprobacionDelCredito(AprobacionCredito motivoNegacionCredito) {
        return instrumented(Negar.class, motivoNegacionCredito);
    }
