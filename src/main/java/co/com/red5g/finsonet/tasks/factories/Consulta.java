...
public final class Consulta {
  ...
  public static Performable elCreditoEnFormalizacionCrediHuy(Credito informacionIncorporacionHuy) {
    return instrumented(IncorporacionCreditoHuy.class, informacionIncorporacionHuy);
  }
}