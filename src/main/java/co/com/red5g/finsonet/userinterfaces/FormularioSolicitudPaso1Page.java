...
public class FormularioSolicitudPaso1Page {
    public static final Target BTN_CIUDADES = Target.the("la ciudad").located(By.xpath("//button[@data-id='txtCiuC']"));
    public static final Target FILTRO_CIUDADES = Target.the("la ciudad").located(By.xpath("//div[contains(@class,'requerir dropup open')]//input[@class='form-control']"));
    ...
    public static final Target BTN_AGENCIA_VINCULACION = Target.the("la ciudad").located(By.xpath("//button[@data-id='a_vinculacion']"));
    public static final Target FILTRO_AGENCIA_VINCULACION = Target.the("la ciudad").locatedBy("//div[contains(@class,'input-form requerir dropup open')]//li[contains(.,'{0}')]");
