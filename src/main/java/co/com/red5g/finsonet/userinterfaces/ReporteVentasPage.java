...
public final class ReporteVentasPage {
    ...
    public static final Target LBL_NUMERO_CREDITOS_FINSOAMIGO = Target.the("el numero total de creditos en finsoamigo").located(By.id("cantidad_fa"));
    ...
    public static final Target LBL_NUMERO_CREDITOS_VENTA_LIBERADA = Target.the("el numero total de creditos en la venta liberada").located(By.id("cantidad_lib"));
