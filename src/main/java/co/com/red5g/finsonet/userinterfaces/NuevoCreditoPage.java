...
public class NuevoCreditoPage {
    ...
    public static final Target LBL_MENSAJE_FALLIDO = Target.the("el mensaje de falla").located(By.xpath("//div[@class='sweet-alert showSweetAlert visible']//h2//following-sibling::p"));
