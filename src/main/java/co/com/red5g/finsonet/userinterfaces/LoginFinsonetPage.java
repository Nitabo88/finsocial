...
public class LoginFinsonetPage extends PageObject {
  ...
  public static final Target TXT_NUEVA_CONTRASENA = Target.the("el mensaje de bienvenido").located(By.id("textfield"));
  public static final Target TXT_CONFIRMACION_CONTRASENA = Target.the("el mensaje de bienvenido").located(By.name("confirme_pass"));
  public static final Target BTN_ACTUALIZAR_CONTRASENA = Target.the("el mensaje de bienvenido").located(By.id("butSubmit"));
}