...
public final class ConfirmacionPage {
    ...
    public static final Target BTN_ACCION_PENDIENTE_HUY = Target.the("Boton aceptar").located(By.xpath("//td[text()='CrediHuy']//parent::tr//a[contains(@href,'{0}')]//ancestor::tr//button[@data-toggle='dropdown']"));
