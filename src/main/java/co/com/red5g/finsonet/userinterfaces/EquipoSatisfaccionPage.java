...
public class EquipoSatisfaccionPage extends PageObject {
    ...
    public static final Target MNU_PQR = Target.the("boton nueva solicitud contact").locatedBy(("//div[@id='sticky-wrapper']//li[@class='dropdown'][contains(.,'PQR')]"));
    public static final Target MNU_BUSQUEDA_PQR = Target.the("boton nueva solicitud contact").locatedBy(("//div[@id='sticky-wrapper']//a[@id='pqr-bus']"));
