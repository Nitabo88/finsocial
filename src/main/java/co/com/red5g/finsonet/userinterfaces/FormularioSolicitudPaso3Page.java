...
public class FormularioSolicitudPaso3Page {
    ...
    public static final Target TXT_CARGO = Target.the("el cargo").located(org.openqa.selenium.By.id("txtCargo"));
    public static final Target TXT_DIRECCION_TRABAJO = Target.the("la opcion de declara renta").located(org.openqa.selenium.By.id("dirTrabajo"));
    public static final Target TXT_FECHA_VINCULACION = Target.the("la fecha de vinculacion").located(org.openqa.selenium.By.id("txtFechaVinculacion"));
    public static final Target TXT_NIT_EMPRESA = Target.the("el NIT de la empresa").located(org.openqa.selenium.By.id("txtNitEmpresa"));
    public static final Target BTN_TIPO_EMPRESA = Target.the("el tipo de empresa").located(org.openqa.selenium.By.xpath("//button[@data-id='cmbTipoEmp']"));
    public static final Target BTN_TIPO_CONTRATO = Target.the("el tipo de contrato").located(org.openqa.selenium.By.xpath("//button[@data-id='cmbTipoContrato']"));
    public static final Target BTN_ACTIVIDAD_ECONOMICA = Target.the("el tipo de actividad economica").located(org.openqa.selenium.By.xpath("//button[@data-id='cmbActEcon']"));
    ...
    public static final Target BTN_CIUDAD_TRABAJO = Target.the("la ciudad de trabajo").located(org.openqa.selenium.By.xpath("//button[@data-id='cmbCiudad2']"));
    public static final Target TXT_TELEFONO_TRABAJO = Target.the("la telefono del trabajo").located(org.openqa.selenium.By.id("txtTelEmpresa"));
    public static final Target TXT_EXTENSION = Target.the("la extension del trabajo").located(org.openqa.selenium.By.id("txtExt"));
    ...
    public static final Target BTN_REGRESAR = Target.the("al boton regresar").located(org.openqa.selenium.By.id("btnRegresar_3"));
    public static final Target BTN_GUARDAR_CONTINUAR = Target.the("el boton guardar y continuar").located(org.openqa.selenium.By.id("btnEnviar_3"));
