...
public final class FormularioSolicitudPaso3Page {
    ...
    public static final Target RDB_IMPACTO_CARGO = Target.the("la opcion de influencia del cargo para la sociedad")
        .locatedBy("//label[@class='radio-inline'][contains(.,'{0}')]/input[@name='txtDesicionCargo']");
    public static final Target RDB_RECURSOS_PUBLICOS = Target.the("la opcion de si maneja recursos publicos")
        .locatedBy("//label[@class='radio-inline'][contains(.,'{0}')]/input[@name='txtrecPublicos']");
    ...
    public static final Target FILTRO_LISTA = Target.the("el filtro de la lista").locatedBy("//div[@class='btn-group bootstrap-select input-form requerir pen open']//input[@class='form-control']");
    public static final Target LST_EMPRESA = Target.the("la lista de empresas").locatedBy("//span[text()='{0}']");
    public static final Target FILTRO_CIUDAD_TRABAJO = Target.the("la lista de ciudades")
        .located(By.xpath("//select[@id='cmbCiudad2']//following-sibling::div//input[@class='form-control']"));
    ...
    public static final Target LST_ACTIVIDAD_ECONOMICA = Target.the("la lista de actividad economica")
        .locatedBy("//select[@id='cmbActEcon']/following-sibling::div//ul[@class='dropdown-menu inner']//li[contains(.,'{0}')]");
