...
public class FormularioSolicitudPaso5Page {
    ...
    public static final Target LST_FILTROS= Target.the("el tipo de documento").locatedBy("//div[@class='btn-group bootstrap-select disabled input-form open']//li[contains(.,'{0}')]");
    ...
    public static final Target BTN_SEXO = Target.the("el sexo").located(By.id("cmbSexoCon"));
    ...
    public static final Target FILTRO_LUGARES= Target.the("el lugar de expedicion").locatedBy("//div[@class='btn-group bootstrap-select disabled input-form dropup open']//input[@class='form-control requerir']");
