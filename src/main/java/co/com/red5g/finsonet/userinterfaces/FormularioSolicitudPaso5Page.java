...
public class FormularioSolicitudPaso5Page {
    ...
    public static final Target FILTRO_LUGARES= Target.the("el lugar de expedicion").located(By.xpath("//div[contains(@class,'disabled input-form open')]//input[@class='form-control requerir']"));
