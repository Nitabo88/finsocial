...
public final class FormularioSolicitudPaso2Page {
    ...
    public static final Target FILTRO_LUGARES= Target.the("el lugar de expedicion").locatedBy("//div[@class='btn-group bootstrap-select input-form requerir dropup open']//input[@class='form-control']");
