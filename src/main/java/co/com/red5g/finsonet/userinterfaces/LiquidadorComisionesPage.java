...
public class LiquidadorComisionesPage extends PageObject {
    ...
    public static final Target LBL_TOTAL_CREDITOS_VENTA_DIRECTA= Target.the("total numero de creditos venta directa").located(By.id("cantidad_vn"));
    public static final Target LBL_TOTAL_VENTA_DIRECTA= Target.the("total del valor de comisiones de venta directa").located(By.id("valor_vn"));
