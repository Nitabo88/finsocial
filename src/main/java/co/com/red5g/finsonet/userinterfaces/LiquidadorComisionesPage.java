...
public class LiquidadorComisionesPage extends PageObject {
    ...
    public static final Target LST_TOTAL_VALOR_LIQUIDACION= Target.the("valor total del pago de creditos").located(By.xpath("//div[@class='panel mt-10']//div[@class='panel-body p-30']//div//div[@class='grid-vertical-center'][contains(text(),'TOTALES')]//parent::div//p[contains(.,'Reliquidado')]//following-sibling::p"));
    ...
    public static final Target LST_TOTALES_VALORES_LIQUIDACION= Target.the("valor consolidado de creditos").locatedBy("//div[@class='table-eyes-body']//div[@class='grid-vertical-center'][contains(.,'{0}')]//parent::div//p[contains(.,'Reliquidado')]//following-sibling::p");
