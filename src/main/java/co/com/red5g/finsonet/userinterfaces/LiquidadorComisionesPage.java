...
public class LiquidadorComisionesPage extends PageObject {
    ...
    public static final Target LST_CICLO = Target.the("ciclo del reporte").located(org.openqa.selenium.By.id("periodoHijo"));
    public static final Target LBL_TOTAL_CREDITOS_VENTA_NUEVA = Target.the("total numero de creditos venta nueva").located(org.openqa.selenium.By.id("cantidad_vn"));
    public static final Target LBL_TOTAL_CREDITOS_VENTA_LIBERADA = Target.the("total numero de creditos venta liberada").located(org.openqa.selenium.By.id("cantidad_lib"));
    public static final Target LBL_TOTAL_VENTA_NUEVA = Target.the("total del valor de comisiones de venta directa").located(org.openqa.selenium.By.id("valor_vn"));
    public static final Target LBL_TOTAL_VENTA_LIBERADA = Target.the("total del valor de comisiones de venta directa").located(org.openqa.selenium.By.id("valor_lib"));
    ...
    public static final Target LST_TOTAL_VALOR_LIQUIDACION = Target.the("valor total del pago de creditos").located(org.openqa.selenium.By.xpath("//div[@class='panel mt-10']//div[@class='panel-body "
        + "p-30']//div//div[@class='grid-vertical-center'][contains(text(),'TOTALES')]//parent::div//p[contains(.,'Total Semana')]//following-sibling::p"));
    public static final Target LST_MONTO_ASESOR = Target.the("los montos por asesor").locatedBy("//div[@class='panel mt-10']//div[@class='panel-body p-30']//div[@class='table-eyes-body'][contains(.,"
        + "'{0}')]//p[contains(.,'Monto')]//following-sibling::p[@class='val']");
    public static final Target LST_NOMBRE_ASESOR = Target.the("El nombre del asesor").located(
        org.openqa.selenium.By.xpath("//div[@class='panel mt-10']//div[@class='panel-body p-30']//div[@class='table-eyes-body']//div[@class='grid-vertical-center']"));
    ...
    public static final Target LBL_CIUDAD_DETALLE = Target.the("nombre del departamento o asesor").located(org.openqa.selenium.By.xpath("//div[@class='tarjeta-info']//p[@class='nom']"));
    ...
    public static final Target BTN_VER_DETALLE_LIQUIDACION = Target.the("detalle de la liquidacion").locatedBy(
        "//div[@class='panel mt-10']//div[@class='panel-body p-30']//div//div[@class='grid-vertical-center'][contains(.,'{0}')]//parent::div[@class='table-eyes-body']//div//p[contains(.,'Acción')]//parent::div//button");
    public static final Target BTN_ATRAS = Target.the("atras del detalle de la liquidacion").located(org.openqa.selenium.By.xpath("//i[@class='far fa-arrow-left fa-25']"));
