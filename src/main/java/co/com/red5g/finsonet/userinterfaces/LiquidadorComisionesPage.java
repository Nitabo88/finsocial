...
public class LiquidadorComisionesPage extends PageObject {
    ...
    public static final Target LST_TOTALES_VALORES_CREDITOS= Target.the("valor consolidado de creditos").located(By.xpath("//div[@class='panel mt-10']//div[@class='panel-body p-30']//div//div[@class='grid-vertical-center'][contains(text(),'TOTALES')]//..//p[contains(.,'Monto')]//following-sibling::p[contains(@class,'val')]"));
    ...
    public static final Target LST_TOTALES_VALORES_LIQUIDACION= Target.the("valor consolidado de creditos").locatedBy("//div[@class='table-eyes-body']//div[@class='grid-vertical-center'][contains(.,'{0}')]//parent::div//p[contains(.,'Total Semana')]//following-sibling::p");
