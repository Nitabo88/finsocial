...
public class LiquidadorComisionesPage extends PageObject {
    ...
    public static final Target LST_TOTAL_VALOR_LIQUIDACION= Target.the("valor total del pago de creditos").located(By.xpath("//div[@class='panel mt-10']//div[@class='panel-body p-30']//div//div[@class='grid-vertical-center'][contains(text(),'TOTALES')]//parent::div[@class='table-eyes-body']//div//p[contains(.,'Total Semana')]//following-sibling::p[@class='qty']"));
    ...
    public static final Target BTN_ATRAS= Target.the("atras del detalle de la liquidacion").located(By.id("btn-back"));
