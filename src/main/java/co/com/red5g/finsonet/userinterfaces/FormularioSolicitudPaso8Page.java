...
public final class FormularioSolicitudPaso8Page {
    ...
    public static final Target BTN_ENCUESTA = Target.the("el boton de encuesta").locatedBy("//div[@class='grid-item'][@data-id='op-{0}']");
    public static final Target LST_BTN_ENCUESTA = Target.the("la lista de botones de la encuesta").locatedBy("//div[@class='grid-item']");
