...
public final class FormularioSolicitudPaso6Page {
    ...
    public static final Target LST_CIUDAD_REFERENCIA_FAMILIAR = Target.the("la lista ciudad de la referencia familiar")
        .located(By.xpath("//button[@data-id = 'cmbCiudadRefFam']//following-sibling::div//input"));
    public static final Target LST_CIUDAD_REFERENCIA_PERSONAL = Target.the("la lista de la referencia personal")
        .located(By.xpath("//button[@data-id = 'cmbCiudadRefPer']//following-sibling::div//input"));
    ...
    public static final Target TXT_NOMBRE_APELLIDO_REFERENCIA_PERSONAL = Target.the("el nombre y apellido de una referencia personal (Que no vive con usted)")
        .located(By.id("ref_personal_nombre"));
