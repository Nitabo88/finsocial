...
public class ConfirmacionLLamadasPage {
  ...
  public static final Target CHK_RESPUESTA_CUATRO = Target.the("Seleccionar la cuarta pregunta").locatedBy("//input[@data-info='1-{0}']");
  public static final Target CHK_RESPUESTA_QUINTO = Target.the("Seleccionar la quinta pregunta").locatedBy("//input[@data-info='2-{0}']");
