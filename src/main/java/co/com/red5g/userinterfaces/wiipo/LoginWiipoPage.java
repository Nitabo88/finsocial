package co.com.red5g.userinterfaces.wiipo;
...
public class LoginWiipoPage extends PageObject {
    ...
    public static final Target LBL_MENSAJE_BIENVENIDO = Target.the("el mensaje de bienvenida").located(By.xpath("//p[@class='blue--dark space-nowrap']"));
}
